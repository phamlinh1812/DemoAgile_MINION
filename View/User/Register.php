<div style="width: 500px;margin: 0 auto; margin-top: 20px;border: solid; border-color: #6495ED; border-radius: 10px;"><center>
	<h2><span><a style="color: #ff6600;font-weight: bold;font-size: 25px; margin-top: 50px" href="index.php?mod=user&act=register">Đăng ký tài khoản</a></span></h2>
  	<p>
    <script language="javascript" src="js/function1.js"></script>
  	<form class="form" method="post" action="index.php?mod=user&act=register" onsubmit="return IsRegister()">
        ...
        <p><label>&nbsp;</label><input type="submit" value="Đăng ký" name="btnRegister" id="btnRegister" style="font-weight:bold;background-color: #b05529"/></p>
