<div style="width: 600px; margin: 10 auto; margin-top: 20px;border: solid; border-color: #6495ED; border-radius: 10px;">
	<center>
	<h2><a style="color: #ff6600;font-weight: bold;font-size: 25px; margin-top: 90px" href="index.php?mod=user&act=login">Đăng nhập tài khoản</a></h2>
     <p>
     ...
     <form method="post" action="index.php?mod=user&act=login" onsubmit="return IsLogin();" class="form">
        ...
        <p><label>&nbsp;</label><input type="submit" name="btnLogin" id="btnLogin" value="Đăng nhập" style="margin-left: 0px;font-weight:bold;background-color: #b05529"/></p>
        <p><a style="color: #ff6600;" href="index.php?mod=user&act=forgotpassword"><b><u>Quên mật khẩu?</u></b></a></p>
